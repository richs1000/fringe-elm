...
var _user$project$MessageTypes$SSData = F6(
	function (a, b, c, d, e, f) {
		return {mastery: a, numerator: b, denominator: c, searchAlgorithm: d, implementMastery: e, debug: f};
	});
			...
			switch (_p3.ctor) {
				...
				case 'GreedySearch':
					return {
						...
						_1: 'Correct. Greedy Search returns the item with the lowest total path cost.'
					};
				default:
					return {
						ctor: '_Tuple2',
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {debug: a, userInput: b, history: c, question: d, success: e, feedback: f, randomValues: g, mastery: h, numerator: i, denominator: j, implementMastery: k, searchAlgorithm: l};
											};
										};
									};
								};
...
var _user$project$Model$initModel = {
	...
	searchAlgorithm: _user$project$Search$AStarSearch
};
			...
			switch (_p0.ctor) {
				...
				case 'NewQuestion':
					var question$ = A2(
						_elm_lang$core$Debug$log,
						'question index ',
						A2(_user$project$Question$newQuestion, model.randomValues, model.searchAlgorithm));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
				...
				default:
					var _p2 = _p0._0;
					var debug$ = A2(_elm_lang$core$Debug$log, 'got values from smart sparrow: ', _p2);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								mastery: _p2.mastery,
								numerator: _p2.numerator,
								denominator: _p2.denominator,
								searchAlgorithm: _user$project$Search$convertToSearchAlgorithm(_p2.searchAlgorithm),
								implementMastery: _p2.implementMastery,
								debug: _p2.debug
							}),
						_1: A2(
							_elm_lang$core$Random$generate,
...
var _user$project$SearchQuestions$subscriptions = function (model) {
	return _user$project$Ports$ssData(_user$project$MessageTypes$GetValuesFromSS);
};
var _user$project$SearchQuestions$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Model$init, view: _user$project$View$view, update: _user$project$Update$update, subscriptions: _user$project$SearchQuestions$subscriptions})
};

var Elm = {};
Elm['SearchQuestions'] = Elm['SearchQuestions'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['SearchQuestions'], 'SearchQuestions', typeof _user$project$SearchQuestions$main === 'undefined' ? null : _user$project$SearchQuestions$main);
