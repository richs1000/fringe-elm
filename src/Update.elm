...
update msg model =
    case msg of
        ...
        NewRandomValues newValues ->
            ...
            , Random.generate NewQuestion (Random.int 1 5)
            )
            ...
            let
                question' =
                    Debug.log "question index "
                        (newQuestion model.randomValues model.searchAlgorithm)
            in
        ...
        GetValuesFromSS ssd ->
            ...
            in
                ( { model
                    ...
                    , searchAlgorithm = convertToSearchAlgorithm ssd.searchAlgorithm
